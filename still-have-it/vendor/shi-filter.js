(() => {
  ...
  var built = ds.build();
  var matcher = new RegExpMatcher({
    blacklistedTerms: built.blacklistedTerms,
    whitelistedTerms: [.../* @__PURE__ */ new Set([...built.whitelistedTerms || [], ...ALLOW])],
    blacklistMatcherTransformers: [
  ...
  var FILTER_MESSAGE = "Keep it friendly\u2014please change this wording.";
  var FILTER_META = {
    package: "obscenity",
